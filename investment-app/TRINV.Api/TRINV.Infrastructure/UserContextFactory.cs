...
{
    /// <summary>
    /// Returns the id for the first claim of the specified type, otherwise null if the claim is not present.
    /// </summary>
    /// <param name="principal">The <see cref="ClaimsPrincipal"/> instance this method extends.</param>
    /// <param name="claimType">The claim type whose first id should be returned.</param>
    /// <returns>The id of the first instance of the specified claim type, or null if the claim is not present.</returns>
